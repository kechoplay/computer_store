                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate method="post"
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="payment_name">Tên hình thức
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="supply_name" class="form-control col-md-7 col-xs-12" name="payment_name"
                                           required="required" type="text" value="{{ old('payment_name') ? old('payment_name') : $payment->payment_name }}">
