                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->level == 1)
                                <li>
                                    <a>
                                        ...
                                        Quản lý nhân viên <span class="fa fa-chevron-down"></span>
                                    </a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ route('listUserView') }}">Thành viên</a></li>
                                        <li><a href="{{ route('addNewUserView') }}">Thêm thành viên</a></li>
...
{{--                                    <li><a href="calendar.html">Calendar</a></li>--}}
                            ...
                            <li><a><i class="fa fa-bar-chart-o"></i> Quản lý khuyến mãi <span
