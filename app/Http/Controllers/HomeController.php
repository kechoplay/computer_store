...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $sanphamnew = SanPham::where('is_new', 1)->take(6)->get();
        ...
        $danhsachsanpham = SanPham::inRandomOrder()->take(9)->get();
...
//            ->take(4)->get();
        return view('User.index', compact('sanphamused', 'sanphamnew', 'danhsachkhuyenmai', 'danhsachsanpham'));
    }
}
